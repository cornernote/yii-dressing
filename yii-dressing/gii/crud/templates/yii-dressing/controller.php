...
echo "        if (\$view != 'index') {\n";
echo "            \$this->breadcrumbs[Yii::t('app', \$this->getName(true))] = Yii::app()->user->getState('index." . lcfirst($this->modelClass) . "', array('/" . lcfirst($this->modelClass) . "/index'));\n";
echo "        }\n";
...
echo "        \$ids = YdHelper::getGridIds(\$id);\n";
